...
public class SubAgrupamentoDto
{
...
public class CreateSubAgrupamentoDto
{
    [Required(ErrorMessage = "ID do agrupamento é obrigatório")]
    public Guid AgrupamentoId { get; set; }
...
public class UpdateSubAgrupamentoDto
{
    [Required(ErrorMessage = "Código é obrigatório")]
    [StringLength(20, ErrorMessage = "Código deve ter no máximo 20 caracteres")]
    public string Codigo { get; set; } = string.Empty;
